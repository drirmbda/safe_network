...
- Fix faucet command sync issue where a loop could be encountered on force paymanet for uploads.
...
- _(release)_ sn_auditor-v0.1.22/sn_faucet-v0.4.24/node-launchpad-v0.3.4
...
- _(faucet_server)_ download and upload gutenberger book part by part
...
- _(faucet_server)_ upload sample files and print head_addresses
- _(faucet_server)_ download some iso files during startup
...
- _(faucet)_ allow gifting by default
- _(faucet)_ increase initial balance
- _(faucet)_ make gifting server feat dependent
- _(faucet)_ send small amount to faucet, rest to foundation
- _(faucet)_ add feat for gifting-from-genesis
- faucet donate endpoint to feed the faucet
- _(faucet)_ fully limit any concurrency
- _(faucet)_ log from sn_client
- report protocol mismatch error

### Fixed

- _(faucet)_ cleanup unused vars
- _(faucet)_ rate limit before getting wallet
- _(faucet)_ ensure faucet is funded in main fn
- update calls to HotWallet::load
- _(faucet)_ fix distribution 'from' wallet loading
...
- _(faucet)_ log initilization failure and upload faucet log
...
- _(faucet)_ start using warp for simpler server tweaks
...
- _(release)_ sn_cli-v0.89.84/sn_node-v0.104.40/sn_networking-v0.13.34/sn_service_management-v0.1.1/sn_client-v0.104.30
...
- _(faucet)_ claim using signature of safe wallet
...
- _(release)_ sn_protocol-v0.14.6/sn_node-v0.104.33/sn-node-manager-v0.3.9/sn_cli-v0.89.78/sn_client-v0.104.25/sn_networking-v0.13.27/sn_node_rpc_client-v0.4.64
...
- _(release)_ sn_networking-v0.13.26/sn-node-manager-v0.3.6/sn_client-v0.104.23/sn_node-v0.104.31
...
- _(release)_ sn_networking-v0.13.21/sn_client-v0.104.16/sn_node-v0.104.24
...
- _(release)_ sn_protocol-v0.14.1/sn-node-manager-v0.3.1/sn_cli-v0.89.68/sn_client-v0.104.13/sn_networking-v0.13.18/sn_node-v0.104.21/sn_node_rpc_client-v0.4.54
...
- token_distribution
- _(release)_ sn_protocol-v0.14.0/sn-node-manager-v0.3.0/sn_cli-v0.89.67/sn_client-v0.104.12/sn_networking-v0.13.17/sn_node-v0.104.20/sn_node_rpc_client-v0.4.53

## [0.3.65](https://github.com/maidsafe/safe_network/compare/sn_faucet-v0.3.64...sn_faucet-v0.3.65) - 2024-02-14

### Other

- _(release)_ sn_protocol-v0.13.0/sn-node-manager-v0.2.0/sn_cli-v0.89.65/sn_client-v0.104.10/sn_networking-v0.13.15/sn_node-v0.104.18/sn_node_rpc_client-v0.4.51
...
- _(faucet)_ improve faucet server response for clippy
- _(release)_ sn_networking-v0.13.12/sn_node-v0.104.12/sn-node-manager-v0.1.59/sn_client-v0.104.7/sn_node_rpc_client-v0.4.46
...
- _(faucet)_ api endpoint to return distribution
...
- _(release)_ sn_networking-v0.13.10/sn_client-v0.104.4/sn_node-v0.104.8
...
- _(faucet)_ initial distributions in background
- _(faucet)_ create distributions for maid addrs

### Other

- _(ci)_ make deps optional if used only inside a feature
- _(faucet)_ fix typo/clippy/fmt after rebase
...
- _(faucet)_ add Snapshot type
- _(faucet)_ get pubkeys from repo not pastebin
- _(faucet)_ custom types for maid values
- _(faucet)_ load public keys for distribution
- _(faucet)_ snapshot is a hashmap<addr, balance>
...
- _(faucet)_ download snapshot of maid balances
...
- _(testnet)_ wait till faucet server starts

### Other

- _(faucet)_ print on claim genesis error
